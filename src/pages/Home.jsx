...
const BLOG_POSTS = [
    { image: '/blog-images/plastic-free-bathroom.jpg', tag: 'Zero Waste', title: 'Plastic-Free Bathroom: 7 Simple Swaps' },
    { image: '/blog-images/herb-garden.jpg', tag: 'Grow', title: 'Grow Your Own Herb Garden Indoors' },
    { image: '/blog-images/eco-travel.jpg', tag: 'Lifestyle', title: 'The Eco-Traveller Packing List' },
];
                    ...
                    <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {BLOG_POSTS.map((post, index) => (
                            ...
                            >
                                ...
                                <div className="p-5">
                                    <p className="text-highlight text-xs font-bold uppercase tracking-wider">{post.tag}</p>
