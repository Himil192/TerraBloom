                ...
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <ul className="  font-medium">
                                    <li className="mb-4">
                                        <a href="https://github.com/themesberg/flowbite" className="hover:text-second-highlight-color">Github</a>
                                    </li>
                                    <li>
                            ...
                            <div>
                                ...
                                <ul className="  font-medium">
                                    <li className="mb-4">
                                        <a href="#" className="hover:text-second-highlight-color">Privacy Policy</a>
                                    </li>
                                    <li>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        ...
                        <div className="flex mt-4 sm:justify-center sm:mt-0">
                            ...
                            <a href="#" className="hover:text-gray-900  text-white  ms-5">
